...
public static class UpdateService
{
    ...
    // ===== 社区版更新源 =====
    private const string GITHUB_OWNER = "Nepnisa";
    private const string GITHUB_REPO = "ObsMCLauncher-CE";
    private const string GITHUB_REPO_URL = "https://github.com/Nepnisa/ObsMCLauncher-CE";
    ...
    {
        OpenReleasePage($"{GITHUB_REPO_URL}/releases/latest");
    }
