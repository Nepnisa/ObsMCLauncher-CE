...
public partial class AboutViewModel : ViewModelBase
{
    ...
    // 社区版版本号硬编码为 1.0.0
    [ObservableProperty]
    private string _versionText = "社区版 v1.0.0";
    ...
    [RelayCommand]
    private static void OpenOfficialRepo() => OpenUrl("https://github.com/mcobs/ObsMCLauncher");

    [RelayCommand]
    private static void OpenCommunityRepo() => OpenUrl("https://github.com/Nepnisa/ObsMCLauncher-CE");
