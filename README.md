...
**ObsMCLauncher-CE** 是一款采用现代 UI 设计的 Minecraft 启动器，基于 Avalonia UI 框架开发，支持跨平台运行。
...
```bash
# 克隆项目
git clone https://github.com/Nepnisa/ObsMCLauncher-CE.git
cd ObsMCLauncher
